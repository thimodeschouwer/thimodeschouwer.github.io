<h2 id="workprogress" class="section-heading">Work in Progress</h2>
...
<div class="pub-row">
  ...
  <div class="col-sm-9">
    ...
    <div class="links">
      {% if link.pdf %}
      <a href="{{ link.pdf }}" class="btn btn-sm z-depth-0 btn-paper" role="button" target="_blank" style="font-size:12px;">PDF</a>
      {% endif %}
      {% if link.code %}
      <a href="{{ link.code }}" class="btn btn-sm z-depth-0 btn-code" role="button" target="_blank" style="font-size:12px;">Code</a>
      {% endif %}
      {% if link.page %}
      <a href="{{ link.page }}" class="btn btn-sm z-depth-0 btn-page" role="button" target="_blank" style="font-size:12px;">Project Page</a>
      {% endif %}
      {% if link.outreach %}
